        ...
        return (
            <div className="container">
                ...
                <p>I Am actually a medical student with a great passion for computer sciences.
                    ...
                    using this <a href='https://github.com/naaficodes/Portfolio_Website_ReactJS'>template/example</a>.
                    <br></br>
                    You can use the social media icons to respectively check my linktree page, my github page and
